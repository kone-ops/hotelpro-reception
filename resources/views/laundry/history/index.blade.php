<x-app-layout>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">{{ $hotel->name }} — Filtrez par période pour voir vos actions sur les collectes et types de linge.</p>
        </div>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form method="get" class="row g-3 align-items-end">
                ...
                <div class="col-md-2">
                    <a href="{{ route('laundry.history.index') }}" class="btn btn-outline-secondary">Réinitialiser</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="card-body">
                            ...
                            @foreach($activities as $log)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <span class="badge bg-secondary">{{ $actionTypeLabels[$actionType] ?? $actionType }}</span>
                                    </td>
            ...
            @else
                <x-super.empty-table
                    ...
                    message="Aucune activité sur la période sélectionnée. Modifiez les dates ou effectuez des actions (collectes, types de linge) pour les voir apparaître ici."
                />
            @endif
        </div>
    </div>
