...
@section('title', 'Test de Connexion')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-wifi"></i> Test de Connexion - {{ $printer->name }}
                    </h3>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="alert alert-{{ $is_online ? 'success' : 'danger' }}">
                                <h6 class="alert-heading">
                                    <i class="fas fa-{{ $is_online ? 'check-circle' : 'times-circle' }}"></i>
                                    {{ $status_message }}
                                </h6>
                                <p class="mb-0">{{ $help_message }}</p>
                            </div>
                        </div>
                        </div>
                        ...
                        <div>
                            <a href="{{ auth()->user()->hasRole('super-admin') ? route('super.printers.print-test', $printer) : route('hotel.printers.print-test', $printer) }}" 
                               class="btn btn-primary">
                                <i class="fas fa-print"></i> Test d'impression
                            </a>
