...
<head>
    ...
    <link href="{{ asset('assets/vendor/bootstrap-icons/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/vendor/bootstrap-icons/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/vendor/bootstrap-icons/fonts/bootstrap-icons.woff2') }}" rel="stylesheet">
    ...
    <style>
        ...
        .accordion-body .nav-link { padding-left: 2.5rem; }
        ...
        @media (max-width: 768px) {
            .top-navbar form { max-width: 140px; }
...
<body>
    ...
    <script src="{{ asset('assets/vendor/bootstrap/bootstrap.bundle.min.css') }}"></script>
    ...
    <script src="{{ asset('assets/vendor/jquery/jszip.min.js')}}"></script>
    <script src="{{ asset('assets/vendor/jquery/pdfmake.min.js')}}"></script>
    <script src="{{ asset('assets/vendor/jquery/vfs_fonts.js')}}"></script>
    ...
    <script>
        ...
        class NotificationSystem {
            constructor() {
                this.pollInterval = 5000; // 5 secondes pour rafraîchissement automatique
                this.basePollInterval = 5000;
                this.maxPollInterval = 30000; // 30 secondes max en cas d'erreur
                this.pollTimer = null;
